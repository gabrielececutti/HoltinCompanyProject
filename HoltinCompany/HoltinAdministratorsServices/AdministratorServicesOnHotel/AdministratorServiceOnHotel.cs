...
{
    public class AdministratorServiceOnHotel : IAdministratorServiceOnHotel
    {
        private readonly IHotelPersistenceService _hotelPersistenceService;

        public AdministratorServiceOnHotel(IHotelPersistenceService hotelPersistenceService)
        {
